...
struct GroupProduct {
    ...
    static func getGroupProduct() -> [GroupProduct] {
        [
        GroupProduct(nameOfGroup: "Адгезивные системы"),
        GroupProduct(nameOfGroup: "Композитные материалы"),
        GroupProduct(nameOfGroup: "Цементы для постоянной фиксации"),
        GroupProduct(nameOfGroup: "Финирование и полировка")
        ]
    }
}
